export default function About(){
    ...
    return(
        <section>
            ...
            <h2 className="text-xl font-semibold sm:text-2xl">Empowering Students with Scholarships, Courses, and Financial Support</h2>
            <br />
            <br />
                ...
                <h2  className="text-xl font-semibold sm:text-2xl">Our Mission: Bridging the Gap Between Talent, Opportunity, and Skills</h2>
                <br />
